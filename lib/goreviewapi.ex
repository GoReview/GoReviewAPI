defmodule Goreviewapi do
  ...
  defdelegate reset_password(id, name, email), to: UserUpdate, as: :reset_pass
  ...
  alias Goreviewapi.Turmas.Delete, as: TurmaDelete
  ...
  alias Goreviewapi.Envios.Get, as: EnvioGet
  ...
  defdelegate get_envio, to: EnvioGet, as: :get_all
